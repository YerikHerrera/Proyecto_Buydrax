...
from app.schemas.usuario import UsuarioCreate, UsuarioListFilters, UsuarioPublic, UsuarioUpdate
...
def crear_usuario(
    ...
    Actor: Admin_RRHH
    """
    return UsuarioService(db).crear(body, actor)
...
def listar_usuarios(
    ...
    return UsuarioService(db).listar(filters, actor)
...
def obtener_usuario(
    ...
    Actor: Usuario autorizado
    """
    return UsuarioService(db).obtener(id_usuario, actor)
...
def actualizar_usuario(
    ...
    Actor: Admin_RRHH
    """
    return UsuarioService(db).actualizar(id_usuario, body, actor)
